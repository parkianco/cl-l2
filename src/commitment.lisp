...
(defun make-finality-tracker (registry &optional (threshold +commitment-finality-blocks+))
  "Create a finality tracker."
  (make-finality-tracker
   :registry registry
   :current-l1-block 0
   :finality-threshold threshold
   :pending-finality (make-hash-table)))
